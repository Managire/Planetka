...
@media (prefers-color-scheme:light){:root{--bg1:#fff;--bg2:#fff;--card:rgba(255,250,242,.92);--line:rgba(83,65,39,.16);--field:#fffdf8;--field-line:#d9cbb8;--text:#1f252d;--muted:#4b5563;--subtle:#667085;--link:#1d4ed8;--button:#1d4ed8;--button-text:#fff;--pre:#f4eadb;--pre-text:#1f252d;--status-muted:#667085;--status-ok:#247a3e;--status-error:#b42318;--shadow:0 20px 60px rgba(60,47,26,.14)}}
