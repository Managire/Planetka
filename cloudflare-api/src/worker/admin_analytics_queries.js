  ...
  return `
      latest_install_editions AS (
        SELECT
          user_id,
          CASE
            WHEN LOWER(COALESCE(install_edition, '')) IN ('studio', 'planetka_studio') THEN 'studio'
            WHEN LOWER(COALESCE(install_edition, '')) = 'hobby' THEN 'hobby'
            WHEN LOWER(COALESCE(install_edition, '')) = 'pro' THEN 'pro'
            WHEN LOWER(COALESCE(install_edition, '')) = 'private' THEN 'pro'
            ELSE 'free'
...
function splitMetricFromRows(rows, valueKey) {
  const split = { free: 0, hobby: 0, pro: 0, studio: 0, total: 0 };
...
function splitActiveCounts() {
  return { free: 0, hobby: 0, pro: 0, studio: 0, total: 0 };
}
  ...
  return {
    ...
    top_line: {
      installs: {
        ...
        hobby: deps.clampNonNegativeInt(topLineInstalls.hobby),
        studio: deps.clampNonNegativeInt(topLineInstalls.studio),
      ...
      resolves: {
        ...
        hobby: deps.clampNonNegativeInt(topLineResolves.hobby),
        studio: deps.clampNonNegativeInt(topLineResolves.studio),
      ...
      tile_requests: {
        ...
        hobby: deps.clampNonNegativeInt(topLineTileRequests.hobby),
        studio: deps.clampNonNegativeInt(topLineTileRequests.studio),
      ...
      gb_served: {
        ...
        hobby: deps.clampNonNegativeInt(topLineBytesServed.hobby),
        studio: deps.clampNonNegativeInt(topLineBytesServed.studio),
    ...
    active: {
      ...
      windows: {
        "6m": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_6m && activeWindows.installs_6m.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_6m && activeWindows.installs_6m.studio),
        ...
        "3m": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_3m && activeWindows.installs_3m.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_3m && activeWindows.installs_3m.studio),
        ...
        "1m": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1m && activeWindows.installs_1m.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1m && activeWindows.installs_1m.studio),
        ...
        "1w": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1w && activeWindows.installs_1w.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1w && activeWindows.installs_1w.studio),
        ...
        "1d": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1d && activeWindows.installs_1d.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1d && activeWindows.installs_1d.studio),
        ...
        "1h": {
          ...
          hobby: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1h && activeWindows.installs_1h.hobby),
          studio: deps.clampNonNegativeInt(activeWindows && activeWindows.installs_1h && activeWindows.installs_1h.studio),
