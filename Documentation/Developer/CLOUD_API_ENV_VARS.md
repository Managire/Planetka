...
The current add-on uses anonymous install sessions and short-lived tile session tokens. It does not prompt for API keys, email addresses, or account activation inside Blender.
