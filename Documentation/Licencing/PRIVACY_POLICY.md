...
Planetka collects the minimum operational data needed to provide hosted data access, licence activation, support, security, and service reliability.
...
Payments are processed by the payment provider or marketplace shown during checkout. Planetka does not store your full card number or full payment-card details.
...
Planetka does not sell, rent, trade, or disclose account, usage, payment, telemetry, or support data to third parties for marketing, advertising, profiling, or independent use.
...
For privacy, account, or data requests, contact Planetka through the support or contact address provided on planetka.io.
