...
These Terms do not replace the GNU GPL license for the add-on source code.
The add-on code is licensed separately under GPL-3.0-or-later. These Terms
...
third-party source attribution required by the source-data licenses and terms.
