...
- Confirm no in-addon data-pack pricing, scene-specific purchase, purchase-history, or licenced-data download workflow is visible in the active 0.8.2 UI.
- Confirm Atmosphere is not visible or registered in the active 0.8.2 UI.
