...
| v0.8.1 | Blender 5.0 primary; Blender 4.5 LTS expected with verification | Pass required before publication | Future update candidate: simplified Free/Pro streaming model, Preview/Balanced/Full as quality modes, Free limited to Preview/Balanced, Pro allowed all qualities. Paid checkout remains a known blocker before paid public launch. |
...
- Verify Free account restrictions: Preview and Balanced allowed worldwide; Full and Pro-only features blocked clearly.
