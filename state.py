...
_SYNC_IDPROP_MAP = {
    ...
    "global_cloud_local_file": "planetka_global_cloud_local_file",
    "enable_local_clouds": "planetka_enable_local_clouds",
    "local_cloud_texture_source": "planetka_local_cloud_texture_source",
    "local_cloud_local_file": "planetka_local_cloud_local_file",
