...
_AUTO_RESOLVE_APPLY_RETRY_MAX_ATTEMPTS = 6
_AUTO_RESOLVE_APPLY_RETRY_BACKOFF_BASE_SEC = 0.5
_AUTO_RESOLVE_APPLY_RETRY_BACKOFF_MAX_SEC = 2.0
...
def _build_auto_resolve_contexts():
    settings = AutoResolveSettings(
        ...
        apply_retry_max_attempts=_AUTO_RESOLVE_APPLY_RETRY_MAX_ATTEMPTS,
        apply_retry_backoff_base_sec=_AUTO_RESOLVE_APPLY_RETRY_BACKOFF_BASE_SEC,
        apply_retry_backoff_max_sec=_AUTO_RESOLVE_APPLY_RETRY_BACKOFF_MAX_SEC,
